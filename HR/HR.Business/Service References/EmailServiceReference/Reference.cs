...
namespace HR.Business.EmailServiceReference {
    ...
    public interface IEmailService {
        ...
        void SendEmail(HR.Business.EmailServiceReference.EmailData data);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmailService/SendEmail", ReplyAction="http://tempuri.org/IEmailService/SendEmailResponse")]
        System.Threading.Tasks.Task SendEmailAsync(HR.Business.EmailServiceReference.EmailData data);
        ...
        void SendEmailWithSimpleAttachments(HR.Business.EmailServiceReference.EmailData data, System.Collections.Generic.Dictionary<string, byte[]> attachments);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmailService/SendEmailWithSimpleAttachments", ReplyAction="http://tempuri.org/IEmailService/SendEmailWithSimpleAttachmentsResponse")]
        System.Threading.Tasks.Task SendEmailWithSimpleAttachmentsAsync(HR.Business.EmailServiceReference.EmailData data, System.Collections.Generic.Dictionary<string, byte[]> attachments);
        ...
        void SendEmailWithAttachments(HR.Business.EmailServiceReference.EmailData data, System.Collections.Generic.List<System.Guid> documentGuids);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmailService/SendEmailWithAttachments", ReplyAction="http://tempuri.org/IEmailService/SendEmailWithAttachmentsResponse")]
        System.Threading.Tasks.Task SendEmailWithAttachmentsAsync(HR.Business.EmailServiceReference.EmailData data, System.Collections.Generic.List<System.Guid> documentGuids);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEmailServiceChannel : HR.Business.EmailServiceReference.IEmailService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EmailServiceClient : System.ServiceModel.ClientBase<HR.Business.EmailServiceReference.IEmailService>, HR.Business.EmailServiceReference.IEmailService {
        ...
        public void SendEmail(HR.Business.EmailServiceReference.EmailData data) {
            base.Channel.SendEmail(data);
        }
        
        public System.Threading.Tasks.Task SendEmailAsync(HR.Business.EmailServiceReference.EmailData data) {
            return base.Channel.SendEmailAsync(data);
        }
        
        public void SendEmailWithSimpleAttachments(HR.Business.EmailServiceReference.EmailData data, System.Collections.Generic.Dictionary<string, byte[]> attachments) {
            base.Channel.SendEmailWithSimpleAttachments(data, attachments);
        }
        
        public System.Threading.Tasks.Task SendEmailWithSimpleAttachmentsAsync(HR.Business.EmailServiceReference.EmailData data, System.Collections.Generic.Dictionary<string, byte[]> attachments) {
            return base.Channel.SendEmailWithSimpleAttachmentsAsync(data, attachments);
        }
        
        public void SendEmailWithAttachments(HR.Business.EmailServiceReference.EmailData data, System.Collections.Generic.List<System.Guid> documentGuids) {
            base.Channel.SendEmailWithAttachments(data, documentGuids);
        }
        
        public System.Threading.Tasks.Task SendEmailWithAttachmentsAsync(HR.Business.EmailServiceReference.EmailData data, System.Collections.Generic.List<System.Guid> documentGuids) {
